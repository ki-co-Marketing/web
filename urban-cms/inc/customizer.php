...
function urban_cms_customizer( WP_Customize_Manager $wp_customize ): void {
	...
	$colors = array(
		'color_primary'       => array( __( 'Primary Color', 'urban-cms' ), '#1a3a5c' ),
		'color_primary_light' => array( __( 'Primary Light', 'urban-cms' ), '#2563a8' ),
		'color_accent'        => array( __( 'Accent / Gold Color', 'urban-cms' ), '#e8a020' ),
	);
...
function urban_cms_output_color_css(): void {
	...
	// phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped -- all values are sanitize_hex_color() (#rrggbb), safe in CSS context
	echo '<style>:root{'
