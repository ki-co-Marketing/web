...
function urban_cms_assets() {
    ...
    // Pass data to JS
    wp_localize_script( 'urban-cms', 'urbanCMS', [
...
function urban_cms_register_rest_routes() {
    register_rest_route( 'urban-cms/v1', '/businesses', [
        'methods'             => 'GET',
    ...
    register_rest_route( 'urban-cms/v1', '/events', [
        'methods'             => 'GET',
...
function urban_cms_rest_businesses( WP_REST_Request $request ) {
    ...
    foreach ( $query->posts as $post ) {
        $businesses[] = [
            ...
            'category' => wp_get_post_terms( $post->ID, 'business_category', [ 'fields' => 'names' ] ),
        ];
    }
