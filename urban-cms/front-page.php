...
$has_stats = false;
for ( $i = 1; $i <= 4; $i++ ) {
    if ( get_theme_mod( "stat_{$i}_number" ) ) { $has_stats = true; break; }
}
if ( $has_stats ) :
?>
...
<section class="section section--alt" aria-labelledby="news-heading">
    <div class="container">
        <?php urban_cms_section_header(
            ...
            get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/news' ),
        ...
        <div class="news-featured">
            ...
            <div class="news-featured__main">
                ...
                get_template_part( 'template-parts/news', 'card', [ 'featured' => true ] );
                wp_reset_postdata();
                ?>
            </div>
...
<section class="section" aria-labelledby="directory-heading">
    <div class="container">
        ...
        <div class="card-grid card-grid--tight">
            <?php while ( $biz_query->have_posts() ) : $biz_query->the_post(); ?>
